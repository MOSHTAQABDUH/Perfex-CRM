...
<div id="mainwrapper">
            ...
            <ul class="nav nav-sidebar">
				<?php foreach ( $menu as $key => $value ) {
                    ...
                    <li id="<?= strtolower( $value->name ); ?>"
                        ...
                        {
						    echo 'active';
					    } ?>"><a href="<?= site_url( $value->link ); ?>"><span
                                    class="menu-icon"><i
                                        class="fa <?= $value->icon; ?>"></i></span><span
                                    class="nav-text"><?php echo $this->lang->line( 'application_'
					                                                               . $value->link ); ?></span>
							<?php if ( strtolower( $value->link ) == 'cmessages'
							           && $messages_new[0]->amount != '0'
							) {
								?>
                                <span class="notification-badge"><?= $messages_new[0]->amount; ?></span><?php
							} ?>
							<?php if ( strtolower( $value->link )
							           == 'quotations'
							           && $quotations_new[0]->amount != '0'
							) {
								?>
    ...
    <div class="content-area">
        <div class="row mainnavbar">
            ...
            <div class="topbar noselect">
                <img class="img-circle topbar-userpic"
                     src="<?= $this->client->userpic; ?>" height="21px">
                <span class="topbar__name fc-dropdown--trigger">
          <?php echo character_limiter( $this->client->firstname . ' '
                                        . $this->client->lastname,
	          25 ); ?> <i class="ion-chevron-down"
                        ...
                        <li class="profile-dropdown__logout">
                            <a href="<?= site_url( 'logout' ); ?>"
                               title="<?= $this->lang->line( 'application_logout' ); ?>">
                                ...
                                <i class="ion-power pull-right"></i>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="modal fade" id="mainModal" tabindex="-1" role="dialog"
         data-backdrop="static" aria-labelledby="mainModalLabel"
