...
<head>
    ...
    <link rel="SHORTCUT ICON"
          href="<?= base_url() ?>assets/blueline/img/favicon.ico"/>
    ...
    <link rel="stylesheet"
          href="<?= base_url() ?>assets/blueline/css/app.css?ver=<?= $core_settings->version; ?>"/>
    <link rel="stylesheet"
          href="<?= base_url() ?>assets/blueline/css/user.css?ver=<?= $core_settings->version; ?>"/>
        ...
        <div class="sidebar">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img
                            src="<?= base_url() ?><?= $core_settings->logo; ?>"
...
//                print_r($menu);
					...
					foreach ( $menu as $key => $value ) {
                        ...
                        <li id="<?= strtolower( $value->name ); ?>"
                            ...
                            <a href="<?= site_url( $value->link ); ?>"
                               data-turbolinks="<?= ( $value->link != 'leads' )
								   ? 'true' : 'false' ?>">
                      <span class="menu-icon">
                          <i class="fa <?= $value->icon; ?>"></i>
                      </span>
                                <span class="nav-text">
                          <?php echo $this->lang->line( 'application_'
                                                        . $value->link ); ?>
                      </span>
								<?php if ( strtolower( $value->name )
								           == 'messages'
								           && $messages_new[0]->amount != '0'
								) {
                                ...
                                <li>
                                    ...
                                    <div class="submenu">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?= base_url() ?>projects/tracking/<?= $value->id; ?>"
				...
				if ( $user_online && $val->link == 'useronline' ) {
                    ...
                    <ul class="nav nav-sidebar user-online menu-sub hidden-sm hidden-xs">
						...
						<?php foreach ( $user_online as $value ):
                            ...
                            <li>
                                <a href="<?= base_url() ?>users/show/<?= $value->id; ?>"
					...
					<?php if ( $client_online ) {
                        ...
                        <ul class="nav nav-sidebar user-online menu-sub hidden-sm hidden-xs">
							...
							<?php foreach ( $client_online as $value ):
                                ...
                                <li>
                                    <a href="#" class="<?= $status; ?>">
                                        <p class="truncate"><img
                                                    class="img-circle"
                                                    src="<?= $value->userpic; ?>"
                                                    width="21px"> <?php echo $value->firstname
										                                     . ' '
										                                     . $value->lastname; ?>
                                        </p>
                                    </a>
    ...
    <div class="content-area" onclick="">
        <div class="row mainnavbar">
            <div class="topbar__left noselect">
                <a href="#" class="menu-trigger"><i
                            class="ion-navicon visible-xs"></i></a>
                ...
                <i class="icon dripicons-bell topbar__icon fc-dropdown--trigger"
                   data-placement="bottom"
                   title="<?= $this->lang->line( 'application_alerts' ); ?>"><?php if ( $notification_count
				                                                                        > 0
					) {
                ...
                <div class="fc-dropdown notification-center">
                    ...
                    <ul class="notificationlist">
						...
						<?php if ( $notification_count == 0 ) {
							?>
                            <li>
                                <p class="truncate"><?= $this->lang->line( 'application_no_events_yet' ); ?></p>
                            </li>
							<?php
						} ?>
                    </ul>
				...
				<?php if ( isset( $projects_icon ) ) {
					?>
                    <i class="icon dripicons-stopwatch topbar__icon fc-dropdown--trigger"
                       data-placement="bottom"
                    ...
                    <div class="fc-dropdown notification-center shortcut-menu">
                        <div class="notification-center__header">
                            <a href="#"
                               class="active"><?= $this->lang->line( 'application_running_timers' ); ?></a>
                        </div>
            ...
            <div class="topbar noselect">
                ...
                <img class="img-circle topbar-userpic" src="<?= $userimage; ?>"
                     height="21px">
                <span class="topbar__name fc-dropdown--trigger">
          <span class="hidden-xs"><?php echo character_limiter( $this->user->firstname
                                                                . ' '
                                                                . $this->user->lastname,
		          25 ); ?></span> <i
    ...
    <!-- Modal -->
    <div class="modal fade" id="mainModal" data-easein="flipXIn" tabindex="-1"
         role="dialog" data-backdrop="static" aria-labelledby="mainModalLabel"
