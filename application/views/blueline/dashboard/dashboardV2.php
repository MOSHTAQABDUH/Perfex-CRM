                            ...
                            <table class="table" id="tickets"
								...
								<?php foreach ( $ticket as $value ): ?>
                                    <tr id="<?= $value->id; ?>">
                                        ...
                                        <td class="hidden-xs"
                                            style="width:15px"><?php if ( $value->updated
										                                  == "1"
										                                  && $user_id
										                                     == $this->user->id
											) { ?><i class="icon dripicons-star"
                                                     style="color: #d48b2a;"></i><?php } else { ?>
                                                <i class="icon dripicons-star"
                                                   style="opacity: 0.2;"></i><?php } ?>
                                        </td>
                                        <td><?= $value->subject; ?></td>
                                        <td class="hidden-xs hidden-md">
                                            <span><?php if ( is_object( $value->queue ) ) {
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#dashboardCalendar').fullCalendar({
			...
			<?php if($core_settings->calendar_google_api_key != ""
			         && $core_settings->calendar_google_event_address != ""){ ?>
