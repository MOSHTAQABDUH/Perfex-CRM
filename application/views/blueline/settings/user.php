        ...
        <div class="box-shadow">
            <div class="table-head">
                ...
                <span class="pull-right">
					<a href="<?= base_url() ?>settings/user_create"
                       class="btn btn-primary" data-toggle="mainmodal">
						<?= $this->lang->line( 'application_create_agent' ); ?>
					</a>
				</span>
            </div>
            <div class="table-div responsive">
                <table id="users" class="data-no-search table" cellspacing="0"
                       cellpadding="0">
                    <thead>
					...
					<?php foreach ( $users as $user ): ?>
                        ...
                        <tr id="<?= $user->id; ?>">
                            ...
                            <td class="hidden-xs">
						<span class="label label-<?php if ( $user->status
						                                    == ' active '
						) {
							echo 'success ';
						} else {
                            ...
                            <td class="hidden-xs">
						<span class="label label-<?php if ( $user->admin
						                                    == ' 1 '
						) {
							echo 'success ';
						} else {
						...
						<span>
							<?php if ( ! empty( $user->last_login ) ) {
								echo date( $core_settings->date_format . ' '
                            ...
                            <td class="option" width="8%">
                                ...
                                <a href="<?= base_url() ?>agents/user_view/<?= $user->id; ?>"
                                   class="btn-option">
