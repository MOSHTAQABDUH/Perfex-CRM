...
<div class="form-group">
    <label for="address"><?=$this->lang->line( 'application_addresss' ); ?>
        *</label>
...
<div class="form-group">
    <label for="zip_code"><?= $this->lang->line( 'application_zip_code' ); ?>
        *</label>
...
<div class="form-group">
    <label for="city"><?= $this->lang->line( 'application_city' ); ?>
        *</label>
    <input id="city" type="text" name="city"
           class="required city form-control"
           value="<?php if ( isset( $user ) ) {
		       echo $user->email;
	       } ?>" required/>
</div>
...
<div class="form-group">
    <label for="phone_country"><?= $this->lang->line( 'application_country' ); ?>
        *</label>
    <input id="country" type="number" name="country"
           class="required country form-control"
           value="<?php if ( isset( $user ) ) {
		       echo $user->email;
	       } ?>" required/>
</div>
<div class="form-group">
    <label for="ssn"><?= $this->lang->line( 'application_ssn' ); ?>
        *</label>
...
<div class="form-group">
    <label for="firstname"><?= $this->lang->line( 'application_registration_number' ); ?>
        *</label>
...
<div class="form-group">
    <label for="phone_number"><?= $this->lang->line( 'application_phone_number' ); ?>
        *</label>
    <input id="phone_number" type="number" name="phone_number"
           class="required phone_number form-control"
           value="<?php if ( isset( $user ) ) {
		       echo $user->email;
	       } ?>" required/>
</div>
...
<div class="form-group">
    ...
    <input id="signature" name="signature" class="form-control"
           value="<?php if ( isset( $user ) ) {
		       echo $user->signature;
	       } ?>"/>
</div>
...
<?php if ( ! isset( $agent ) ) {
    ...
    <div class="form-group">
        <label for="title"><?= $this->lang->line( 'application_title' ); ?>
            *</label>
        <input id="title" type="text" name="title" class="required form-control"
               value="<?php if ( isset( $user ) ) {
			       echo $user->title;
		       } ?>" required/>
    </div>
